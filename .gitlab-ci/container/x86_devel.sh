...
#echo -e '#!/bin/bash\n\necho nothing to do for "build-virglrenderer.sh"' > .gitlab-ci/container/build-virglrenderer.sh

echo -e '#!/bin/bash\n\necho nothing to do for "build-piglit.sh"' > .gitlab-ci/container/build-piglit.sh

echo -e '#!/bin/bash\n\necho nothing to do for "build-deqp.sh"' > .gitlab-ci/container/build-deqp.sh

# libdrm is already built ...
echo -e '#!/bin/bash\n\necho nothing to do for "build-libdrm.sh"' > .gitlab-ci/container/build-libdrm.sh
...
# rust is already built ...
echo -e '#!/bin/bash\n\necho nothing to do for "build-rust.sh"' > .gitlab-ci/container/build-rust.sh

# deqp-runner is already built ...
echo -e '#!/bin/bash\n\necho nothing to do for "build-deqp-runner.sh"' > .gitlab-ci/container/build-deqp-runner.sh
