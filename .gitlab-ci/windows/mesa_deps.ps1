...
git clone -b 5b641633b3bcc3251a52260eee11db13a79d7258 https://github.com/KhronosGroup/SPIRV-LLVM-Translator llvm-project/llvm/projects/SPIRV-LLVM-Translator
if (!$?) {
