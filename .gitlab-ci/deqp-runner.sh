...
if [ -z "$DEQP_VER" -a -z "$DEQP_SUITE" ]; then
   echo 'DEQP_SUITE muist be set to the name of your deqp-gpu_version.toml, or DEQP_VER must be set to something like "gles2", "gles31-khr" or "vk" for the test run'
   exit 1
fi
