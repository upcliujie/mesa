...
2. Generate the project:
   ...
   .. code-block:: console
      ...
      meson build -Dperfetto=true -Dgallium-drivers=swrast,panfrost
...
1. Create a `trace config <https://perfetto.dev/#/trace-config.md>`__, which is a json formatted text file with extension ``.cfg``, or use one of those under the ``script`` directory.
