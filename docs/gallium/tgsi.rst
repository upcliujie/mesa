...
TGSI supports 32-bit absolute value and negate modifiers on floating-point
inputs.  Floating point inputs are those where tgsi_opcode_infer_src_type()
returns TGSI_TYPE_FLOAT, and also TGSI_OPCODE_MOV and the second and third
operands of TGSI_OPCODE_UCMP.
