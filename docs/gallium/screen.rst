...
* ``PIPE_CAP_SAMPLER_REDUCTION_MINMAX``: Driver support min/max sampler reduction; PIPE_SAMPLER_REDUCTION_MINMAX_EXT for EXT, PIPE_SAMPLER_REDUCTION_MINMAX_ARB for ARB.
