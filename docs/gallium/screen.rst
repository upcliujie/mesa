...
* ``PIPE_CAP_SHADER_IMAGE_COMPAT_BY_CLASS``: Driver wants to report `IMAGE_FORMAT_COMPATIBILITY_BY_CLASS` instead of `IMAGE_FORMAT_COMPATIBILITY_BY_SIZE` from `GetTexParameter*`.
