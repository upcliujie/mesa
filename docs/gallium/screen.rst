...
* ``PIPE_CAP_MUL_ZERO_WINS``: Whether TGSI shaders support the
  ``TGSI_PROPERTY_MUL_ZERO_WINS`` shader property and NIR shaders support the
  `is_arb_asm` property that 0*x=0.
