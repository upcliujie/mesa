...
OpenGL: vertex buffers in GL 1.5 or :gl-ext:`ARB_vertex_buffer_object`

- Binding to stream out requires GL 3.0 or :gl-ext:`NV_transform_feedback`
- Binding as constant buffers requires GL 3.1 or :gl-ext:`ARB_uniform_buffer_object`
- Binding to a sampling stage requires GL 3.1 or :gl-ext:`ARB_texture_buffer_object`
...
- PIPE_CAP_NPOT_TEXTURES is equivalent to GL 2.0 or :gl-ext:`ARB_texture_non_power_of_two`
...
OpenGL: GL_TEXTURE_RECTANGLE in GL 3.1 or :gl-ext:`ARB_texture_rectangle` or
:gl-ext:`NV_texture_rectangle`
...
OpenGL: GL_TEXTURE_3D in GL 1.2 or :gl-ext:`EXT_texture3D`
...
OpenGL: GL_TEXTURE_CUBE_MAP in GL 1.3 or :gl-ext:`EXT_texture_cube_map`

- PIPE_CAP_NPOT_TEXTURES is equivalent to GL 2.0 or :gl-ext:`ARB_texture_non_power_of_two`
- Seamless cube maps require GL 3.2 or :gl-ext:`ARB_seamless_cube_map` or :gl-ext:`AMD_seamless_cubemap_per_texture`
- Cube map arrays require GL 4.0 or :gl-ext:`ARB_texture_cube_map_array`
...
OpenGL: FBOs are collections of surfaces in GL 3.0 or :gl-ext:`ARB_framebuffer_object`
