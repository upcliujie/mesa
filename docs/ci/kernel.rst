...
Every kernel uprev should update 4 image tags, located at two files.
...
- **DEBIAN_X86_TEST_GL_TAG** and **DEBIAN_X86_TEST_VK_TAG** to ensure that the new rootfs is being used by the Gitlab x86 jobs
