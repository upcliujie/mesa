...
Issues
    ...
    simplifies application support for otherwise GLES2 hardware (Intel
    Pineview, Broadcom VC4, NVIDIA G98, ATI R500...) and for drivers in
    bringup that haven't yet achieved GLES3 (etnaviv, at the moment).
...
Revision History
    ...
    ----  --------    --------  ---------------------------------------------
      ...
      2   2019/11/14  ajax      Add extension interactions:
                                  ...
                                  - EXT_texture_sRGB_decode
                                  - OES_texture_border_clamp
      3   2020/12/02  ajax      Expand the justification and ES3 interaction
