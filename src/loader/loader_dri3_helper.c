                          ...
                          struct loader_dri3_drawable *draw)
{
   ...
   draw->avoid_back_buffer_reuse = avoid_back_buffer_reuse;
...
dri3_find_back(struct loader_dri3_drawable *draw, bool prefer_a_different)
{
   ...
   /* In a DRI_PRIME situation, first try to find an idle buffer that is not
    * the last used one.
                ...
                struct loader_dri3_drawable *draw)
{
   ...
   if (buffer_type == loader_dri3_buffer_back) {
      ...
      buf_id = dri3_find_back(draw, !draw->avoid_back_buffer_reuse);
