...
create_gl_core_context()
{
   ...
   static const char *egl_extension[] = {"EGL_KHR_create_context", "EGL_KHR_surfaceless_context"};
   ...
   static const EGLint config_attribs[] = {EGL_RENDERABLE_TYPE, EGL_OPENGL_BIT, EGL_NONE};
   EGLConfig cfg;
   EGLint count;
   ...
   static const EGLint attribs[] = {EGL_CONTEXT_OPENGL_PROFILE_MASK_KHR,
