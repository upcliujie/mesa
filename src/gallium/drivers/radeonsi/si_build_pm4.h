...
#define radeon_end_update_context_roll(sctx)                                                                           \
   do {                                                                                                                \
      radeon_end();                                                                                                    \
 ...
 */
#define radeon_emit_array_get_ptr(num, ptr)                                                                            \
   do {                                                                                                                \
      *(ptr) = __cs_buf + __cs_num;                                                                                    \
      __cs_num += (num);                                                                                               \
   } while (0)

#define radeon_set_config_reg_seq(reg, num)                                                                            \
   do {                                                                                                                \
...
#define radeon_set_context_reg_seq_array(reg, num, values)                                                             \
   do {                                                                                                                \
      radeon_set_context_reg_seq(reg, num);                                                                            \
      radeon_emit_array(values, num);                                                                                  \
   } while (0)

#define radeon_set_context_reg_idx(reg, idx, value)                                                                    \
   do {                                                                                                                \
      assert((reg) >= SI_CONTEXT_REG_OFFSET);                                                                          \
...
#define radeon_set_sh_reg_idx3_seq(sctx, reg, num)                                                                     \
   do {                                                                                                                \
      assert((reg) >= SI_SH_REG_OFFSET && (reg) < SI_SH_REG_END);                                                      \
...
#define radeon_set_sh_reg_idx3(sctx, reg, value)                                                                       \
   do {                                                                                                                \
      radeon_set_sh_reg_idx3_seq(sctx, reg, 1);                                                                        \
      radeon_emit(value);                                                                                              \
   } while (0)

#define radeon_set_uconfig_reg_seq(reg, num, perfctr)                                                                  \
   do {                                                                                                                \
...
#define radeon_set_uconfig_reg_perfctr(reg, value)                                                                     \
   do {                                                                                                                \
      radeon_set_uconfig_reg_seq(reg, 1, true);                                                                        \
      radeon_emit(value);                                                                                              \
   } while (0)

#define radeon_set_uconfig_reg_idx(screen, gfx_level, reg, idx, value)                                                 \
   do {                                                                                                                \
      assert((reg) >= CIK_UCONFIG_REG_OFFSET && (reg) < CIK_UCONFIG_REG_END);                                          \
      assert((idx) != 0);                                                                                              \
      unsigned __opcode = PKT3_SET_UCONFIG_REG_INDEX;                                                                  \
      if ((gfx_level) < GFX9 || ((gfx_level) == GFX9 && (screen)->info.me_fw_version < 26))                            \
...
#define radeon_opt_set_context_reg(sctx, offset, reg, val)                                                             \
   do {                                                                                                                \
...
#define radeon_opt_set_context_reg_idx(sctx, offset, reg, idx, val)                                                    \
   do {                                                                                                                \
      unsigned __value = val;                                                                                          \
      if (((sctx->tracked_regs.context_reg_saved_mask >> (reg)) & 0x1) != 0x1 ||                                       \
          sctx->tracked_regs.context_reg_value[reg] != __value) {                                                      \
 ...
 */
#define radeon_opt_set_context_reg2(sctx, offset, reg, val1, val2)                                                     \
   do {                                                                                                                \
 ...
 */
#define radeon_opt_set_context_reg3(sctx, offset, reg, val1, val2, val3)                                               \
   do {                                                                                                                \
 ...
 */
#define radeon_opt_set_context_reg5(sctx, offset, reg, val0, val1, val2, val3, val4)                                   \
   do {                                                                                                                \
 ...
 */
#define radeon_opt_set_context_regn(sctx, offset, value, saved_val, num)                                               \
   do {                                                                                                                \
...
#define radeon_opt_set_sh_reg(sctx, offset, reg, val)                                                                  \
   do {                                                                                                                \
      unsigned __value = val;                                                                                          \
 ...
 */
#define radeon_opt_set_sh_reg2(sctx, offset, reg, val1, val2)                                                          \
   do {                                                                                                                \
      unsigned __value1 = (val1), __value2 = (val2);                                                                   \
 ...
 */
#define radeon_opt_set_sh_reg3(sctx, offset, reg, val1, val2, val3)                                                    \
   do {                                                                                                                \
      unsigned __value1 = (val1), __value2 = (val2), __value3 = (val3);                                                \
...
#define radeon_opt_set_sh_reg_idx3(sctx, offset, reg, val)                                                             \
   do {                                                                                                                \
      unsigned __value = val;                                                                                          \
      if (((sctx->tracked_regs.other_reg_saved_mask >> (reg)) & 0x1) != 0x1 ||                                         \
          sctx->tracked_regs.other_reg_value[reg] != __value) {                                                        \
...
#define radeon_opt_set_uconfig_reg(sctx, offset, reg, val)                                                             \
   do {                                                                                                                \
      unsigned __value = val;                                                                                          \
      if (((sctx->tracked_regs.other_reg_saved_mask >> (reg)) & 0x1) != 0x1 ||                                         \
          sctx->tracked_regs.other_reg_value[reg] != __value) {                                                        \
...
#define radeon_emit_32bit_pointer(sscreen, va)                                                                         \
   do {                                                                                                                \
      radeon_emit(va);                                                                                                 \
      assert((va) == 0 || ((va) >> 32) == sscreen->info.address32_hi);                                                 \
   } while (0)

#define radeon_emit_one_32bit_pointer(sctx, desc, sh_base)                                                             \
   do {                                                                                                                \
...
si_get_user_data_base(enum amd_gfx_level gfx_level, enum si_has_tess has_tess, enum si_has_gs has_gs,
