                               ...
                               struct lower_resource_state *s)
{
   ...
   nir_ssa_def *image = texture_deref ? load_deref_sampler_desc(b, texture_deref, desc_type, s, !tex->texture_non_uniform) : load_bindless_sampler_desc(b, texture_handle, desc_type, s);
