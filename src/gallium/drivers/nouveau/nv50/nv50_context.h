...
// TODO(pmoreau): Check that nothing got broken
#define NV50_BIND_CP_CB(i)    ( 0 + (i)) // TODO(pmoreau): Check it is correct
#define NV50_BIND_CP_TEXTURES  16        // TODO(pmoreau): Check it is correct
