...
OPCODE(1, 3, OTHR, ATOMU64ADD, .is_store = 1)
OPCODE(1, 3, OTHR, ATOM64XCHG, .is_store = 1)
OPCODE(1, 4, OTHR, ATOM64CAS, .is_store = 1)
OPCODE(1, 3, OTHR, ATOM64AND, .is_store = 1)
OPCODE(1, 3, OTHR, ATOM64OR, .is_store = 1)
OPCODE(1, 3, OTHR, ATOM64XOR, .is_store = 1)
OPCODE(1, 3, OTHR, ATOMU64MIN, .is_store = 1)
OPCODE(1, 3, OTHR, ATOMU64MAX, .is_store = 1)
OPCODE(1, 3, OTHR, ATOMI64MIN, .is_store = 1)
OPCODE(1, 3, OTHR, ATOMI64MAX, .is_store = 1)
