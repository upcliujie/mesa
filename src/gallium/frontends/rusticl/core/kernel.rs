...
impl KernelArg {
    ...
    fn deserialize(bin: &mut &[u8]) -> Result<Self, ()> {
...
fn deserialize_nir(
    bin: &mut &[u8],
    d: &Device,
) -> Result<(NirShader, Vec<KernelArg>, Vec<InternalKernelArg>), ()> {
