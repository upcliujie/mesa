...
static const char *const lsc_operation[32] = {
   [LSC_OP_LOAD]            = "load",
   [LSC_OP_LOAD_BLOCK]      = "load_block",
   [LSC_OP_LOAD_CMASK]      = "load_cmask",
   [LSC_OP_STORE]           = "store",
   [LSC_OP_STORE_BLOCK]     = "store_block",
...
static const char *const lsc_addr_surface_type[8] = {
...
static const char* const lsc_fence_scope[16] = {
...
static const char* const lsc_flush_type[8] = {
...
static const char* const lsc_addr_size[4] = {
   [LSC_ADDR_SIZE_A16] = "a16",
   [LSC_ADDR_SIZE_A32] = "a32",
   [LSC_ADDR_SIZE_A64] = "a64",
};

static const char* const lsc_backup_fence_routing[2] = {
   [LSC_NORMAL_ROUTING]  = "normal_routing",
   [LSC_ROUTE_TO_LSC]    = "route_to_lsc",
};

static const char* const lsc_data_size[8] = {
   [LSC_DATA_SIZE_D8]      = "d8",
...
static const char* const lsc_vect_size_str[8] = {
   [LSC_VECT_SIZE_V1] = "V1",
   [LSC_VECT_SIZE_V2] = "V2",
   [LSC_VECT_SIZE_V3] = "V3",
   [LSC_VECT_SIZE_V4] = "V4",
...
static const char* const lsc_cmask_str[16] = {
   [LSC_CMASK_X]      = "x",
   [LSC_CMASK_Y]      = "y",
   [LSC_CMASK_XY]     = "xy",
   [LSC_CMASK_Z]      = "z",
...
static const char* const lsc_cache_load[8] = {
...
static const char* const lsc_cache_store[8] = {
