...
static const char *const dp_oword_block_rw[8] = {
      [BRW_DATAPORT_OWORD_BLOCK_1_OWORDLOW]  = "1 oword-low",
      [BRW_DATAPORT_OWORD_BLOCK_1_OWORDHIGH] = "1 oword-high",
      [BRW_DATAPORT_OWORD_BLOCK_2_OWORDS]    = "2 owords",
      [BRW_DATAPORT_OWORD_BLOCK_4_OWORDS]    = "4 owords",
      [BRW_DATAPORT_OWORD_BLOCK_8_OWORDS]    = "8 owords",
};
