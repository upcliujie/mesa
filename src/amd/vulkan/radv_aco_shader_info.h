...
static inline void
radv_aco_convert_shader_vs_info(struct aco_vs_output_info *aco_info,
...
#define ASSIGN_OUTINFO(x) radv_aco_convert_shader_vs_info(&aco_info->x.outinfo, &radv->x.outinfo);
static inline void
