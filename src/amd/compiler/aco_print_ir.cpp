...
void aco_print_block(const Block* block, FILE *output, unsigned flags, live *live_vars)
{
   fprintf(output, "BB%d\n", block->index);
...
void aco_print_program(const Program *program, FILE *output, unsigned flags, live *live_vars)
{
