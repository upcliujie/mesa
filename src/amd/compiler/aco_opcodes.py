...
U8 = SrcDestInfo(AluType.alu_uint, 8, 1, None, False)
...
U96 = SrcDestInfo(AluType.alu_uint, 32, 3, None, False)
U128 = SrcDestInfo(AluType.alu_uint, 32, 4, None, False)
U256 = SrcDestInfo(AluType.alu_uint, 32, 8, None, False)
U512 = SrcDestInfo(AluType.alu_uint, 32, 16, None, False)
