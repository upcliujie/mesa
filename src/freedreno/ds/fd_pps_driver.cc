...
Counter::Value
FreedrenoDriver::DerivedCounter::getter(const Counter &c, const Driver &d)
{
   return reinterpret_cast<const DerivedCounter &>(c).derive();
}
