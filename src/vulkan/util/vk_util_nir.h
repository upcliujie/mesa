...
#ifndef VK_UTIL_NIR_H
#define VK_UTIL_NIR_H
...
static inline struct nir_spirv_specialization*
                          ...
                          uint32_t *out_num_spec_entries)
{
   ...
   struct nir_spirv_specialization *spec_entries =
      (struct nir_spirv_specialization *)calloc(num_spec_entries, sizeof(*spec_entries));
