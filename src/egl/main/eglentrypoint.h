...
EGL_ENTRYPOINT(eglQueryCurrentRendererIntegerMESA)
EGL_ENTRYPOINT(eglQueryCurrentRendererStringMESA)
...
EGL_ENTRYPOINT(eglQueryRendererIntegerMESA)
EGL_ENTRYPOINT(eglQueryRendererStringMESA)
