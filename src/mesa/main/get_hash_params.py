...
# == GL_VERTEX_PROGRAM_NV
  [ "VERTEX_PROGRAM_ARB", "CONTEXT_BOOL(VertexProgram.Enabled), NO_EXTRA" ],
# == GL_VERTEX_PROGRAM_POINT_SIZE_NV
  [ "VERTEX_PROGRAM_POINT_SIZE_ARB", "CONTEXT_BOOL(VertexProgram.PointSizeEnabled), NO_EXTRA" ],
# == GL_VERTEX_PROGRAM_TWO_SIDE_NV
  [ "VERTEX_PROGRAM_TWO_SIDE_ARB", "CONTEXT_BOOL(VertexProgram.TwoSideEnabled), NO_EXTRA" ],
# == GL_MAX_TRACK_MATRIX_STACK_DEPTH_NV
  [ "MAX_PROGRAM_MATRIX_STACK_DEPTH_ARB", "CONTEXT_INT(Const.MaxProgramMatrixStackDepth), NO_EXTRA" ],
# == GL_MAX_TRACK_MATRICES_NV
  [ "MAX_PROGRAM_MATRICES_ARB", "CONTEXT_INT(Const.MaxProgramMatrices), NO_EXTRA" ],
# == GL_CURRENT_MATRIX_STACK_DEPTH_NV
  [ "CURRENT_MATRIX_STACK_DEPTH_ARB", "LOC_CUSTOM, TYPE_INT, 0, NO_EXTRA" ],
# == GL_CURRENT_MATRIX_NV
  [ "CURRENT_MATRIX_ARB", "LOC_CUSTOM, TYPE_MATRIX, 0, NO_EXTRA" ],
# == GL_CURRENT_MATRIX_NV
  [ "TRANSPOSE_CURRENT_MATRIX_ARB", "LOC_CUSTOM, TYPE_MATRIX_T, 0, NO_EXTRA" ],
# == GL_PROGRAM_ERROR_POSITION_NV
  [ "PROGRAM_ERROR_POSITION_ARB", "CONTEXT_INT(Program.ErrorPos), NO_EXTRA" ],
