...
# GL 4.3 / GL_KHR_shader_subgroup
  [ "SUBGROUP_SIZE_KHR", "CONTEXT_INT(Const.ShaderSubgroupSize), extra_version_43_KHR_shader_subgroup" ],
  [ "SUBGROUP_SUPPORTED_STAGES_KHR", "CONTEXT_INT(Const.ShaderSubgroupSupportedStages), extra_version_43_KHR_shader_subgroup" ],
  [ "SUBGROUP_SUPPORTED_FEATURES_KHR", "CONTEXT_INT(Const.ShaderSubgroupSupportedFeatures), extra_version_43_KHR_shader_subgroup" ],
  [ "SUBGROUP_QUAD_ALL_STAGES_KHR", "CONTEXT_BOOL(Const.ShaderSubgroupQuadAllStages), extra_version_43_KHR_shader_subgroup" ],
]},
