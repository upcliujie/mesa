...
EXT(ARB_ES2_compatibility                   , dummy_true                             , GLL, GLC,  x ,  x , 2009)
...
EXT(ARB_draw_elements_base_vertex           , dummy_true                             , GLL, GLC,  x ,  x , 2009)
...
EXT(ARB_half_float_vertex                   , dummy_true                             , GLL, GLC,  x ,  x , 2008)
...
EXT(ARB_internalformat_query                , dummy_true                             , GLL, GLC,  x ,  x , 2011)
...
EXT(ARB_provoking_vertex                    , dummy_true                             , GLL, GLC,  x ,  x , 2009)
...
EXT(ARB_shadow                              , dummy_true                             , GLL,  x ,  x ,  x , 2001)
...
EXT(ARB_sync                                , dummy_true                             , GLL, GLC,  x ,  x , 2003)
...
EXT(ARB_texture_non_power_of_two            , dummy_true                             , GLL, GLC,  x ,  x , 2003)
...
EXT(ARB_texture_rectangle                   , dummy_true                             , GLL, GLC,  x ,  x , 2004)
...
EXT(ARB_vertex_program                      , dummy_true                             , GLL,  x ,  x ,  x , 2002)
EXT(ARB_vertex_shader                       , dummy_true                             , GLL, GLC,  x ,  x , 2002)
...
EXT(ATI_blend_equation_separate             , dummy_true                             , GLL, GLC,  x ,  x , 2003)
EXT(ATI_draw_buffers                        , dummy_true                             , GLL,  x ,  x ,  x , 2002)
EXT(ATI_fragment_shader                     , dummy_true                             , GLL,  x ,  x ,  x , 2001)
EXT(ATI_meminfo                             , ATI_meminfo                            , GLL, GLC,  x ,  x , 2009)
EXT(ATI_separate_stencil                    , dummy_true                             , GLL,  x ,  x ,  x , 2006)
EXT(ATI_texture_compression_3dc             , ATI_texture_compression_3dc            , GLL,  x ,  x ,  x , 2004)
EXT(ATI_texture_env_combine3                , dummy_true                             , GLL,  x ,  x ,  x , 2002)
...
EXT(EXT_EGL_image_storage                   , dummy_true                             , GLL, GLC , x ,  30, 2018)
...
EXT(EXT_blend_equation_separate             , dummy_true                             , GLL, GLC,  x ,  x , 2003)
...
EXT(EXT_draw_elements_base_vertex           , dummy_true                             ,  x ,  x ,  x , ES2, 2014)
...
EXT(EXT_provoking_vertex                    , dummy_true                             , GLL, GLC,  x ,  x , 2009)
...
EXT(EXT_shadow_funcs                        , dummy_true                             , GLL,  x ,  x ,  x , 2002)
EXT(EXT_stencil_two_side                    , dummy_true                             , GLL,  x ,  x ,  x , 2001)
...
EXT(EXT_texture_rectangle                   , dummy_true                             , GLL,  x ,  x ,  x , 2004)
...
EXT(MESA_framebuffer_flip_y                 , dummy_true                             ,  43,  43,  x ,  30, 2018)
...
EXT(NV_copy_image                           , dummy_true                             , GLL, GLC,  x ,  x,  2009)
...
EXT(NV_texture_rectangle                    , dummy_true                             , GLL,  x ,  x ,  x , 2000)
...
EXT(OES_EGL_image                           , dummy_true                             , GLL, GLC, ES1, ES2, 2006) /* FIXME: Mesa expects GL_OES_EGL_image to be available in OpenGL contexts. */
EXT(OES_EGL_image_external                  , dummy_true                             ,  x ,  x , ES1, ES2, 2010)
EXT(OES_EGL_image_external_essl3            , dummy_true                             ,  x ,  x ,  x ,  30, 2015)
EXT(OES_EGL_sync                            , dummy_true                             ,  x ,  x , ES1, ES2, 2010)
EXT(OES_blend_equation_separate             , dummy_true                             ,  x ,  x , ES1,  x , 2009)
...
EXT(OES_texture_npot                        , dummy_true                             ,  x ,  x , ES1, ES2, 2005)
...
EXT(OES_vertex_half_float                   , dummy_true                             ,  x ,  x ,  x , ES2, 2005)
