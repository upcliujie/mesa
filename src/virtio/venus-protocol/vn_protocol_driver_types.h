...
static inline size_t
vn_sizeof_VkShaderModuleCreateFlagBits(const VkShaderModuleCreateFlagBits *val)
{
    assert(sizeof(*val) == sizeof(int32_t));
    return vn_sizeof_int32_t((const int32_t *)val);
}
...
static inline void
vn_encode_VkShaderModuleCreateFlagBits(struct vn_cs *cs, const VkShaderModuleCreateFlagBits *val)
{
    vn_encode_int32_t(cs, (const int32_t *)val);
}

static inline void
vn_decode_VkShaderModuleCreateFlagBits(struct vn_cs *cs, VkShaderModuleCreateFlagBits *val)
{
    vn_decode_int32_t(cs, (int32_t *)val);
}
