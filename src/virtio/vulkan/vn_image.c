                            ...
                            const VkAllocationCallbacks *alloc)
{
   ...
   vk_foreach_struct_const(src, create_info->pNext) {
      ...
      case VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_ANDROID:
         /* Deferring the external format translation involves more
          * complications, so we just track whether the create format is
          * translated from a non-zero external format.
          */
