 ...
 * contents undefined.
 *
 * Except that the spec says this about external resources
 *
 *    (Applications must) Acquire exclusive ownership in the destination
 *    instance or API
 *
 * We should get the spec changed/clarified, or get rid of this broken code
 * (TODO).
 *
   ...
   *img_barrier = (VkImageMemoryBarrier)
   {
      ...
      .oldLayout = att->acquire ? VK_IMAGE_LAYOUT_PRESENT_SRC_KHR
                                : VK_IMAGE_LAYOUT_GENERAL,
      .newLayout = att->acquire ? VK_IMAGE_LAYOUT_GENERAL
